...
class Ui_Dialog_estimation_settings(object):
    def setupUi(self, Dialog_estimation_settings):
        ...
        self.groupBox_drift_polynomial = QtWidgets.QGroupBox(self.tab_advanced_settings)
        self.groupBox_drift_polynomial.setObjectName("groupBox_drift_polynomial")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(self.groupBox_drift_polynomial)
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.formLayout_9 = QtWidgets.QFormLayout()
        self.formLayout_9.setObjectName("formLayout_9")
        self.label_10 = QtWidgets.QLabel(self.groupBox_drift_polynomial)
        self.label_10.setObjectName("label_10")
        self.formLayout_9.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_10)
        self.verticalLayout_13 = QtWidgets.QVBoxLayout()
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        self.radioButton_drift_ref_epoch_first_ob_campaign = QtWidgets.QRadioButton(self.groupBox_drift_polynomial)
        ...
        self.radioButton_drift_ref_epoch_first_obs_survey = QtWidgets.QRadioButton(self.groupBox_drift_polynomial)
        ...
        self.checkBox_drift_ref_epoch_active_obs_only = QtWidgets.QCheckBox(self.groupBox_drift_polynomial)
        self.checkBox_drift_ref_epoch_active_obs_only.setChecked(True)
        self.checkBox_drift_ref_epoch_active_obs_only.setObjectName("checkBox_drift_ref_epoch_active_obs_only")
        self.verticalLayout_14.addWidget(self.checkBox_drift_ref_epoch_active_obs_only)
        self.verticalLayout_9.addWidget(self.groupBox_drift_polynomial)
    ...
    def retranslateUi(self, Dialog_estimation_settings):
        ...
        self.groupBox_drift_polynomial.setTitle(_translate("Dialog_estimation_settings", "Drift Polynomial"))
        ...
        self.checkBox_drift_ref_epoch_active_obs_only.setToolTip(_translate("Dialog_estimation_settings", "Consider only active observations in the determination of the drift polynomial reference epoch(s)."))
        self.checkBox_drift_ref_epoch_active_obs_only.setText(_translate("Dialog_estimation_settings", "Consider only active observations for the reference epoch"))
