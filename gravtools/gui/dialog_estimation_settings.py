...
class Ui_Dialog_estimation_settings(object):
    def setupUi(self, Dialog_estimation_settings):
        ...
        Dialog_estimation_settings.resize(513, 599)
        ...
        self.checkBox_iterative_s0_scaling.setChecked(True)
        ...
        self.groupBox_iterative_scaling = QtWidgets.QGroupBox(self.tab_advanced_settings)
        ...
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_target_s02)
        ...
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.doubleSpinBox_target_s02)
        ...
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_delta_target_s02)
        ...
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.doubleSpinBox_delta_target_s02)
        ...
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.spinBox_max_number_of_iterations)
        ...
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_max_number_of_iterations)
        self.label_max_additive_const_to_sd = QtWidgets.QLabel(self.groupBox_iterative_scaling)
        self.label_max_additive_const_to_sd.setObjectName("label_max_additive_const_to_sd")
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_max_additive_const_to_sd)
        self.doubleSpinBox_max_additive_const_to_sd = QtWidgets.QDoubleSpinBox(self.groupBox_iterative_scaling)
        self.doubleSpinBox_max_additive_const_to_sd.setMaximum(100.0)
        ...
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.doubleSpinBox_max_additive_const_to_sd)
        self.doubleSpinBox_initial_step_size = QtWidgets.QDoubleSpinBox(self.groupBox_iterative_scaling)
        self.doubleSpinBox_initial_step_size.setMinimum(0.1)
        ...
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.doubleSpinBox_initial_step_size)
        self.label_initial_setp_size = QtWidgets.QLabel(self.groupBox_iterative_scaling)
        self.label_initial_setp_size.setObjectName("label_initial_setp_size")
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_initial_setp_size)
        self.verticalLayout_5.addLayout(self.formLayout_4)
        self.verticalLayout_9.addWidget(self.groupBox_iterative_scaling)
