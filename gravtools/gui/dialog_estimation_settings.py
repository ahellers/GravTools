...
class Ui_Dialog_estimation_settings(object):
    def setupUi(self, Dialog_estimation_settings):
        ...
        Dialog_estimation_settings.resize(433, 561)
        ...
        self.label_2 = QtWidgets.QLabel(self.groupBox_adjustment_settings)
    ...
    def retranslateUi(self, Dialog_estimation_settings):
        ...
        self.label_2.setToolTip(_translate("Dialog_estimation_settings", "A prio standard deviation of the unit weight."))
        self.label_2.setText(_translate("Dialog_estimation_settings", "Sig0"))
        self.doubleSpinBox_sig0.setToolTip(_translate("Dialog_estimation_settings", "A prio standard deviation of the unit weight."))
        self.groupBox_constraints.setTitle(_translate("Dialog_estimation_settings", "Constraints"))
        self.label_3.setToolTip(_translate("Dialog_estimation_settings", "Weight factor for datum constraints: Multiplicative factor for the standard deviation of g at datum stations."))
        self.label_3.setText(_translate("Dialog_estimation_settings", "Weight factor for datum"))
        self.doubleSpinBox_weight_factor_datum.setToolTip(_translate("Dialog_estimation_settings", "Weight factor for datum constraints: Multiplicative factor for the standard deviation of g at datum stations."))
