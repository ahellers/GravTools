...
class Ui_Dialog_estimation_settings(object):
    ...
    def retranslateUi(self, Dialog_estimation_settings):
        ...
        self.label_sig0.setToolTip(_translate("Dialog_estimation_settings", "A priori standard deviation of the unit weight. The covariance matrix of observations (Sig_ll) will be divided by sig0²!"))
        self.label_sig0.setText(_translate("Dialog_estimation_settings", "Sig0"))
        self.doubleSpinBox_sig0.setToolTip(_translate("Dialog_estimation_settings", "A priori standard deviation of the unit weight. The covariance matrix of observations (Sig_ll) will be divided by sig0²!"))
