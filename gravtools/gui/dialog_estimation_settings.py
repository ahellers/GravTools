...
class Ui_Dialog_estimation_settings(object):
    def setupUi(self, Dialog_estimation_settings):
        ...
        self.doubleSpinBox_initial_step_size_percent.setProperty("value", 10.0)
        ...
        self.doubleSpinBox_max_multiplicative_factor_to_sd_percent.setProperty("value", 50.0)
        ...
        self.tabWidget_estimation_settings.setCurrentIndex(2)
