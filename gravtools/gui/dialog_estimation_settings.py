...
class Ui_Dialog_estimation_settings(object):
    def setupUi(self, Dialog_estimation_settings):
        ...
        self.checkBox_drif_ref_epoch_active_obs_only = QtWidgets.QCheckBox(self.groupBox_drift_polynomial)
        self.checkBox_drif_ref_epoch_active_obs_only.setChecked(True)
        self.checkBox_drif_ref_epoch_active_obs_only.setObjectName("checkBox_drif_ref_epoch_active_obs_only")
        self.verticalLayout_14.addWidget(self.checkBox_drif_ref_epoch_active_obs_only)
    ...
    def retranslateUi(self, Dialog_estimation_settings):
        ...
        self.checkBox_drif_ref_epoch_active_obs_only.setToolTip(_translate("Dialog_estimation_settings", "Consider only active observations in the determination of the drift polynomial reference epoch(s)."))
        self.checkBox_drif_ref_epoch_active_obs_only.setText(_translate("Dialog_estimation_settings", "Consider only active observations for the reference epoch"))
