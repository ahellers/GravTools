...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_obs_setups = QtWidgets.QGroupBox(self.layoutWidget)
        self.groupBox_obs_setups.setEnabled(False)
        self.groupBox_obs_setups.setObjectName("groupBox_obs_setups")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.groupBox_obs_setups)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.pushButton_obs_comp_setup_data = QtWidgets.QPushButton(self.groupBox_obs_setups)
        self.pushButton_obs_comp_setup_data.setObjectName("pushButton_obs_comp_setup_data")
        self.verticalLayout_11.addWidget(self.pushButton_obs_comp_setup_data)
        self.verticalLayout_5.addWidget(self.groupBox_obs_setups)
        ...
        self.tableView_setups = QtWidgets.QTableView(self.tab_setups_table)
        self.tableView_setups.setObjectName("tableView_setups")
        self.verticalLayout_15.addWidget(self.tableView_setups)
        ...
        self.tabWidget_setups.setCurrentIndex(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_obs_setups.setTitle(_translate("MainWindow", "Setups"))
        self.pushButton_obs_comp_setup_data.setToolTip(_translate("MainWindow", "Combine all observations per setup in oder to compute a singel pseudo observation."))
        self.pushButton_obs_comp_setup_data.setText(_translate("MainWindow", "Compute setup data"))
