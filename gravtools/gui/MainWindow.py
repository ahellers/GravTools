...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_11 = QtWidgets.QLabel(self.groupBox_gis_data)
        self.label_11.setObjectName("label_11")
        self.formLayout_7.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_11)
        self.lineEdit_results_epsg = QtWidgets.QLineEdit(self.groupBox_gis_data)
        self.lineEdit_results_epsg.setObjectName("lineEdit_results_epsg")
        self.formLayout_7.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEdit_results_epsg)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setToolTip(_translate("MainWindow", "<html><head/><body><p>Please declare the CRS of the station coordinates by a valid EPSG code. </p></body></html>"))
        self.label_11.setText(_translate("MainWindow", "EPSG"))
        self.lineEdit_results_epsg.setToolTip(_translate("MainWindow", "<html><head/><body><p>Please declare the CRS of the station coordinates by a valid EPSG code. </p></body></html>"))
