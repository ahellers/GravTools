...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_gis_data.setToolTip(_translate("MainWindow", "<html><head/><body><p>Export  the current content of the observations and the stations table to an ESRI shapefile (&lt;campaign name&gt;_obs.shp and &lt;campaign name&gt;_stat.shp). Please declare the CRS of the station coordinates by a valid EPSG code. </p></body></html>"))
