...
class Ui_Dialog_export_results(object):
    def setupUi(self, Dialog_export_results):
        ...
        self.radioButton_2 = QtWidgets.QRadioButton(self.groupBox_nsb_file)
        ...
        self.buttonGroup_sd_se.addButton(self.radioButton_2)
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.radioButton_2)
        self.radioButton = QtWidgets.QRadioButton(self.groupBox_nsb_file)
        self.radioButton.setChecked(True)
        self.radioButton.setObjectName("radioButton")
        self.buttonGroup_sd_se.addButton(self.radioButton)
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.radioButton)
    ...
    def retranslateUi(self, Dialog_export_results):
        ...
        self.radioButton_2.setToolTip(_translate("Dialog_export_results", "<html><head/><body><p>Export the standard deviations (SD) of the gravity estimates.</p></body></html>"))
        self.radioButton_2.setText(_translate("Dialog_export_results", "Export std. deviation (SD)"))
        self.radioButton.setToolTip(_translate("Dialog_export_results", "<html><head/><body><p>Export the standard errors (SE) of the gravity estimates.</p></body></html>"))
        self.radioButton.setText(_translate("Dialog_export_results", "Export std. error (ED)"))
