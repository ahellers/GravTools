...
class Ui_Dialog_export_results(object):
    def setupUi(self, Dialog_export_results):
        ...
        Dialog_export_results.resize(433, 571)
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.groupBox_observation_list)
        ...
        self.verticalLayout_5.addWidget(self.checkBox_write_observation_list)
    ...
    def retranslateUi(self, Dialog_export_results):
        ...
        self.checkBox_save_drift_plot_png.setText(_translate("Dialog_export_results", "save current drift plot (PNG file)"))
