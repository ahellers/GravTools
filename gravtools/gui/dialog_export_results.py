...
class Ui_Dialog_export_results(object):
    def setupUi(self, Dialog_export_results):
        ...
        Dialog_export_results.resize(433, 577)
    ...
    def retranslateUi(self, Dialog_export_results):
        ...
        self.groupBox_observation_list.setToolTip(_translate("Dialog_export_results", "The observation list file contains either a list of all observations, or of all active or inactive observations. These files are required to save the actual selection of observations (gravitimeter reading) and can be loaded to restore this setup later."))
