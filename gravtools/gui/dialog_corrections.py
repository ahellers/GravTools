...
class Ui_Dialog_corrections(object):
    def setupUi(self, Dialog_corrections):
        ...
        Dialog_corrections.resize(398, 591)
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(Dialog_corrections)
        ...
        self.groupBox_scale_correction = QtWidgets.QGroupBox(Dialog_corrections)
