...
class Ui_Dialog_corrections(object):
    def setupUi(self, Dialog_corrections):
        ...
        Dialog_corrections.resize(380, 451)
        ...
        self.checkBox_corrections_atm_pressure = QtWidgets.QCheckBox(Dialog_corrections)
    ...
    def retranslateUi(self, Dialog_corrections):
        ...
        self.checkBox_corrections_atm_pressure.setToolTip(_translate("Dialog_corrections", "<html><head/><body><p>Use measured pressure values provided in the input observation files to correct atmosperhic pressure variations. Be aware that this correction is only applied, if pressure measurements are provided along with the observaiton data. </p><p>The normal air pressure according to ISO 2533:1975 is used to calculate the corrections.</p></body></html>"))
