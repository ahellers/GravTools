...
class Ui_Dialog_corrections(object):
    def setupUi(self, Dialog_corrections):
        ...
        Dialog_corrections.resize(362, 437)
        ...
        self.checkBox_corrections_atm_pressure = QtWidgets.QCheckBox(self.groupBox_corrections_ref_heights)
        self.checkBox_corrections_atm_pressure.setChecked(True)
        self.checkBox_corrections_atm_pressure.setObjectName("checkBox_corrections_atm_pressure")
        self.verticalLayout_4.addWidget(self.checkBox_corrections_atm_pressure)
    ...
    def retranslateUi(self, Dialog_corrections):
        ...
        self.checkBox_corrections_atm_pressure.setToolTip(_translate("Dialog_corrections", "<html><head/><body><p>Use measured pressure values provided in the input observation files to correct atmosperhic pressure variations. Be aware that this correction is only applied, if pressure measurements are provided along with the observaiton data.</p></body></html>"))
        self.checkBox_corrections_atm_pressure.setText(_translate("Dialog_corrections", "Atmospheric pressure variations"))
